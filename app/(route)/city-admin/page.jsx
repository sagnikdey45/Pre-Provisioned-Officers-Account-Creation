...
import { transformCityAdminData } from "@/lib/transformData";
...
export default function SystemAdminPage() {
  ...
  const handleSubmitToDatabase = () => {
    ...
    const result = transformCityAdminData(officers);
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-teal-700/80 dark:text-cyan-300/80 mt-1">
            Pre-provision and manage city admin accounts efficiently
          </p>
        </div>
